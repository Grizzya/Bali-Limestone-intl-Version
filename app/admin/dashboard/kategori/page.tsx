                    ...
                    <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="p-4 text-right">
                        <div className="flex justify-end gap-2">
                          <Link href={`/admin/dashboard/kategori/edit/${item.id}`} className="px-3 py-1.5 bg-yellow-100 text-yellow-700 rounded text-sm font-medium hover:bg-yellow-200 transition-colors">
                            Edit
                          </Link>
